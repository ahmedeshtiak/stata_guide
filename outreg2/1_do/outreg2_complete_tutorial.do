...
global PROJECT_DIR "D:\Ahmed Eshtiak\Local Disk D\STATA Github\stata_guide\outreg2"
cd "$PROJECT_DIR"

* Organized project folders:
*   0_data            input/generated datasets
*   1_do              Stata scripts
*   2_result/0_excel  Excel/table outputs
*   2_result/1_doc    Word outputs
*   2_result/2_latex  LaTeX outputs
global DO_DIR "1_do"
global DATA_DIR "0_data"
global OUTPUT_DIR "2_result"
global TABLE_DIR "$OUTPUT_DIR/0_excel"
global DOC_DIR "$OUTPUT_DIR/1_doc"
global TEX_DIR "$OUTPUT_DIR/2_latex"

capture mkdir "$DO_DIR"
...
/*=============================================================================
  ...
  outreg2 [varlist] using "$TABLE_DIR/filename.xls",  ///
  ...
  - using    : specifies output filename and folder
...
/*
  ...
  - Companion text file "$TABLE_DIR/basic.txt"
...
**********************************
regress income_el treat hh_size hh_female_hh hh_age_head hh_edu_head hh_land_owned i.district, vce(cluster village_id)
outreg2 using "$TABLE_DIR/sumstat_notes.xls", replace ctitle (SE Clustered) drop (*.district) label nocons addstat("Adj. R-sq", e(r2_a), "F-statistic", e(F), "RMSE", e(rmse))  addtext ("District FE", "Yes", "Covariates", "Yes", "SE Clustered", "Village") addnote("Standard errors clustered at village level.", "*** p<0.01 ** p<0.05 * p<0.1")
...
outreg2 using "$TABLE_DIR/sortvar.xls", replace ctitle ("With Control") label nocons stats (coef pval) addtext ("District FE", "No", "Covariates", "Yes", "SE Clustered", "No") sortvar(treat hh_size hh_female_hh hh_age_head hh_edu_head hh_land_owned)
